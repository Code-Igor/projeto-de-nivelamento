...
CREATE TABLE solicitacao_denuncia (
	id_denuncia BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE solicitacao_coleta (
	id_coleta BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE verificacao_status (
	id_status BIGINT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	id_denuncia BIGINT,
	id_coleta BIGINT,
